...
# these are for 40ms timebuckets
########################################################
...
pulsing_dots_end = {key:None for key in stim_vids}
uniques_start = {key:None for key in stim_vids}
uniques_end = {key:None for key in stim_vids}
